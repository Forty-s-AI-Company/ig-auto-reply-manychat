...
const requiredPaths = [
  ...
  path.join(aiTeamRoot, "skills", "README.md"),
  path.join(aiTeamRoot, "skills", "ui-ux-pro-max-skill.md"),
  path.join(aiTeamRoot, "skills", "design-md-skill.md"),
  path.join(aiTeamRoot, "skills", "impeccable-skill.md"),
  path.join(aiTeamRoot, "skills", "shadcn-skill.md"),
  path.join(aiTeamRoot, "skills", "web-design-guidelines-skill.md"),
  path.join(aiTeamRoot, "skills", "security-best-practices-skill.md"),
...
function buildStatus() {
  ...
  const parts = [
    ...
    section("LOCAL_SKILLS", buildSkillSummary(3)),
    "",
...
function buildFallbackNextPrompt() {
  ...
  return [
    ...
    "- AI_TEAM/skills/ui-ux-pro-max-skill.md",
    "- AI_TEAM/skills/design-md-skill.md",
    "- AI_TEAM/skills/impeccable-skill.md",
    "- AI_TEAM/skills/shadcn-skill.md",
    "- AI_TEAM/skills/web-design-guidelines-skill.md",
    "- AI_TEAM/skills/security-best-practices-skill.md",
