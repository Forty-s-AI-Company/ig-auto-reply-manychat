...
- [x] 1000 user load test 第一波優化已開始。2026-05-31 已完成 Prisma pool 預設調整、webhook queue-first、broadcast batch expansion、Contacts / Conversations / Inbox pagination 與 user/workspace 短 TTL cache；20-user smoke retest 為 50 requests / 0 errors / 0% error rate，但 1000-user retest 仍為 1452 requests / 891 errors / 61.36% error rate，仍不可宣稱可承受 1000 人同時在線。
