...
- `REQUIRED_SKILLS`: ui-ux-pro-max, impeccable, web-design-guidelines, shadcn, security-best-practices, design-md
...
- priority: 3
- skills: ui-ux-pro-max, impeccable, web-design-guidelines, shadcn, security-best-practices, design-md
