  ...
  return (
    <div className="space-y-1">
      <button
        ...
        aria-describedby={disabledReason || message ? "instagram-profile-refresh-status" : undefined}
        className="inline-flex items-center gap-1.5 rounded-md border border-[#f79009] bg-white px-3 py-1.5 text-xs font-medium text-[#b54708] hover:bg-[#fffaeb] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#b54708] focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:border-[#d7dbe0] disabled:bg-[#f8fafc] disabled:text-[#98a2b3] disabled:opacity-80"
      >
