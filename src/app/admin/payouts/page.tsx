...
export default async function AdminPayoutsPage() {
  ...
  return (
    <AdminShell title="Admin Payouts" headerRight={<Link className="rounded-md bg-cyan-500 px-3 py-2 text-sm font-bold text-zinc-950" href="/admin/payouts/batches">Batches</Link>}>
