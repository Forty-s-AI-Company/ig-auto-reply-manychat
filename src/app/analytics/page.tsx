      ...
      <div className="space-y-5">
        ...
        >
          ...
          {analyticsError ? (
            <div
              role="alert"
              data-testid="analytics-error-alert"
              className="mt-3 inline-flex items-center gap-2 rounded-md border border-red-200 bg-white px-3 py-2 text-xs font-medium text-red-900"
            >
